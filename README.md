...
## Business Objective
This project aims to predict loan default using borrower financial and credit data. By identifying high-risk borrowers, the model helps support data-driven lending decisions and reduce financial risk.
...
- Observed relationship between grade and default
- Studied distribution of FICO score across loan status
- Identified key risk factors such as credit grade and FICO score
...
## Key Result
- Improved recall for defaulters from ~64% to ~73% using threshold tuning
